...
@Slf4j
@Component
public class WorkflowEntityDataFetcher {
  ...
  public WorkflowEntityDataFetcher(EntityFetcherService entityFetcherService, RunRepository runRepository, RunService runService) {
